...
icon_counts, total_count, output_image_path = count_icons(input_image_path, icon_folder, icon_prefix, num_icons)
count_string = ', '.join([f"{key}:, {value}" for key, value in icon_counts.items()])
print(count_string)
print("合計アイコン数:", total_count)
print("結果画像パス:", output_image_path)
